...
public class LastSales extends javax.swing.JInternalFrame 
{
    private final Connection con = connect();
    public static ReceiptDetails recD;
    public LastSales() 
    {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        to_textfield = new com.toedter.calendar.JDateChooser();
        jLabel4 = new javax.swing.JLabel();
        from_textfield = new com.toedter.calendar.JDateChooser();

        setClosable(true);
        setIconifiable(true);
        setTitle("Al Receipts");
        setMinimumSize(new java.awt.Dimension(1156, 521));
        setPreferredSize(new java.awt.Dimension(1157, 676));

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        jLabel1.setText("All Receipts");
        ...
        to_textfield.setDateFormatString("yyyy-MM-dd");

        jLabel4.setText("From");

        from_textfield.setDateFormatString("yyyy-MM-dd");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(to_textfield, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jLabel4)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(from_textfield, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(83, 83, 83)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(from_textfield, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 28, Short.MAX_VALUE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(to_textfield, javax.swing.GroupLayout.DEFAULT_SIZE, 28, Short.MAX_VALUE)
    ...
    private void search_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_search_btnActionPerformed
        ...
        model.setRowCount(0);
        String from = ((JTextField) from_textfield.getDateEditor().getUiComponent()).getText();
        String to = ((JTextField) to_textfield.getDateEditor().getUiComponent()).getText();
            
        if(!receipt_num_textfield.getText().isEmpty() || (!from.isEmpty() && !to.isEmpty()))
        {
            Object[] rowData = new Object[3];
            try {
                String query = "SELECT `Receipt_ID`,COUNT(`Receipt_ID`), `Receipt_Date`, `Total_Price` FROM `receipts` "+
                               "WHERE `Receipt_ID`= '"+receipt_num_textfield.getText()+"' OR `Receipt_Date` Between '"+from+"' AND '"+to+"' GROUP BY `Receipt_ID` HAVING COUNT(`Receipt_ID`) >= 1;";                
    ...
    private void list_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_list_btnActionPerformed
        if(table.getSelectedRow() != -1) {
            ...
            recD = new ReceiptDetails();
            recD.setVisible(true);
            JTable table1 = recD.table2;
            DefaultTableModel model = (DefaultTableModel) table1.getModel();
            Object[] rowData = new Object[7];
            
            String query = "SELECT Name, Type,Description,EffectiveMaterial,Price,ProductionDate,ExpirationDate,Paid,Residual,Customer_Name FROM `receipts` JOIN `sold_products` "
            ...
            recD.total_textfield.setText(String.valueOf(df.format(totalBefor)));
            recD.discount_textfield.setText(String.valueOf(df.format(sale)));
            recD.calculated_total__textfield.setText(df.format(Double.parseDouble(totalPrice)));
            recD.pay_textfield1.setText(df.format(paid));
    ...
    private com.toedter.calendar.JDateChooser from_textfield;
    ...
    private com.toedter.calendar.JDateChooser to_textfield;
